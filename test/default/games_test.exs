defmodule Default.GamesTest do
  ...
  describe "games" do
    ...
    @valid_attrs %{month: "some month", game: "some game", status: "some status"}
    @update_attrs %{month: "some updated month", game: "some updated game", status: "some updated status"}
    @invalid_attrs %{month: nil, game: nil, status: nil}
